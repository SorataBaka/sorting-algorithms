...
all: $(BIN_DIR)/counting $(BIN_DIR)/insert $(BIN_DIR)/bubble $(BIN_DIR)/shaker $(BIN_DIR)/quick $(BIN_DIR)/algcomp
...
$(BIN_DIR)/algcomp: algcomp.c $(OBJ)
	$(CC) $(CFLAGS) algcomp.c sort.o -o $(BIN_DIR)/algcomp
